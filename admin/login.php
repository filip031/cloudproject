...
<body background="https://my-35-2019.s3.amazonaws.com/image/blood-cells.jpg">
  ...
  <form class="" action="<?php $_SERVER['PHP_SELF']; ?>" method="post">
    ...
    <div class="container" style="margin-top:200px;">
      ...
      <div class="card" style="height:250px; background-image:url('https://my-35-2019.s3.amazonaws.com/image/glossy1.jpg');">
          <div class="card-body">
